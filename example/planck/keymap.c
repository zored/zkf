...
enum dance_action_names {
  ...
  ACTION_SEQ__TOGGLE_LAYER_EMOJI_16,
  ACTION_SEQ__Z_18,
  ACTION_SEQ__LCTRL_20,
  ACTION_SEQ__LCTRL__LSHIFT_21,
  ACTION_SEQ__LCTRL__LALT__LGUI_22,
  ACTION_SEQ__X_24,
  ACTION_SEQ__LALT_26,
  ACTION_SEQ__LALT__LSHIFT_27,
  ACTION_SEQ__C_29,
  ACTION_SEQ__LGUI_31,
  ACTION_SEQ__LGUI__LSHIFT_32,
  ACTION_SEQ__COMM_34,
  ACTION_SEQ__RGUI_36,
  ...
  ACTION_SEQ__F9_93,
  ACTION_SEQ__F19_94,
  ACTION_SEQ__1F60F_97,
  ACTION_SEQ__1F60E_98,
  ACTION_SEQ__1F4AA_99,
  ACTION_SEQ__1F525_100,
  ACTION_SEQ__1F44D_103,
  ACTION_SEQ__1F44C_104,
  ACTION_SEQ__1F197_105,
  ACTION_SEQ__1F61A_108,
  ACTION_SEQ__1F60D_109,
  ACTION_SEQ__1F618_110,
  ACTION_SEQ__1F496_111,
  ACTION_SEQ__F4_114,
  ACTION_SEQ__F14_115,
  ACTION_SEQ__F5_118,
  ACTION_SEQ__F15_119,
  ...
  switch (dance_key) {
    ...
    code_down(KC_LCTRL);
          ...
          case 3:
            ...
            dance_key_states[dance_key] = ACTION_SEQ__TOGGLE_LAYER_EMOJI_16;
            return;
      ...
      if (state->pressed) {
        ...
        switch (state->count) {
          ...
          case 3:
            ...
            dance_key_states[dance_key] = ACTION_SEQ__LCTRL__LALT__LGUI_22;
            return;
    ...
    case DANCE_KC_CDANCE:
      if (state->pressed) {
        ...
        switch (state->count) {
          case 1:
            code_down(KC_LGUI);
            dance_key_states[dance_key] = ACTION_SEQ__LGUI_31;
            return;
      
          case 2:
            code_down_2(KC_LGUI, KC_LSHIFT);
            dance_key_states[dance_key] = ACTION_SEQ__LGUI__LSHIFT_32;
            return;
        ...
        switch (state->count) {
          case 1:
            code_down(KC_C);
            dance_key_states[dance_key] = ACTION_SEQ__C_29;
            return;
    ...
    case DANCE_KC_F7DANCE:
      if (state->pressed) {
        ...
        switch (state->count) {
          case 1:
            code_down(KC_F7);
            dance_key_states[dance_key] = ACTION_SEQ__F7_85;
            return;
      
          case 2:
            code_down(KC_F17);
            dance_key_states[dance_key] = ACTION_SEQ__F17_86;
            return;
    ...
    case DANCE_KC_F8DANCE:
      if (state->pressed) {
        ...
        switch (state->count) {
          case 1:
            code_down(KC_F8);
            dance_key_states[dance_key] = ACTION_SEQ__F8_89;
            return;
      
          case 2:
            code_down(KC_F18);
            dance_key_states[dance_key] = ACTION_SEQ__F18_90;
            return;
    ...
    case DANCE_KC_F9DANCE:
      if (state->pressed) {
        ...
        switch (state->count) {
          case 1:
            code_down(KC_F9);
            dance_key_states[dance_key] = ACTION_SEQ__F9_93;
            return;
      
          case 2:
            code_down(KC_F19);
            dance_key_states[dance_key] = ACTION_SEQ__F19_94;
            return;
      ...
      if (state->pressed) {
        ...
        switch (state->count) {
          case 1:
            ...
            dance_key_states[dance_key] = ACTION_SEQ__1F60F_97;
            return;
      
          case 2:
            tap_unicode(EMOJI_1F60E);
    
            dance_key_states[dance_key] = ACTION_SEQ__1F60E_98;
            return;
      
          case 3:
            tap_unicode(EMOJI_1F4AA);
    
            dance_key_states[dance_key] = ACTION_SEQ__1F4AA_99;
            return;
      
          case 4:
            tap_unicode(EMOJI_1F525);
    
            dance_key_states[dance_key] = ACTION_SEQ__1F525_100;
            return;
      ...
      if (state->pressed) {
        ...
        switch (state->count) {
          case 1:
            ...
            dance_key_states[dance_key] = ACTION_SEQ__1F44D_103;
            return;
      
          case 2:
            tap_unicode(EMOJI_1F44C);
    
            dance_key_states[dance_key] = ACTION_SEQ__1F44C_104;
            return;
      
          case 3:
            tap_unicode(EMOJI_1F197);
    
            dance_key_states[dance_key] = ACTION_SEQ__1F197_105;
            return;
      ...
      if (state->pressed) {
        ...
        switch (state->count) {
          case 1:
            ...
            dance_key_states[dance_key] = ACTION_SEQ__1F61A_108;
            return;
      
          case 2:
            tap_unicode(EMOJI_1F60D);
    
            dance_key_states[dance_key] = ACTION_SEQ__1F60D_109;
            return;
      
          case 3:
            tap_unicode(EMOJI_1F618);
    
            dance_key_states[dance_key] = ACTION_SEQ__1F618_110;
            return;
      
          case 4:
            tap_unicode(EMOJI_1F496);
    
            dance_key_states[dance_key] = ACTION_SEQ__1F496_111;
            return;
  ...
  switch (dance_key_states[dance_key]) {
    case ACTION_SEQ__HOLD_LAYER_SYMBOL_3:
        ...
        case ACTION_SEQ__LCTRL_20:
          ...
          case ACTION_SEQ__LCTRL__LALT__LGUI_22:
        ...
        case ACTION_SEQ__LGUI_31:
            code_up(KC_LGUI);
            break;
    
          case ACTION_SEQ__LGUI__LSHIFT_32:
            code_up_2(KC_LGUI, KC_LSHIFT);
            break;
        case ACTION_SEQ__C_29:
            code_up(KC_C);
            break;
        ...
        case ACTION_SEQ__F7_85:
            code_up(KC_F7);
            break;
    
          case ACTION_SEQ__F17_86:
            code_up(KC_F17);
            break;
    
        
        case ACTION_SEQ__F8_89:
            code_up(KC_F8);
            break;
    
          case ACTION_SEQ__F18_90:
            code_up(KC_F18);
            break;
    
        
        case ACTION_SEQ__F9_93:
            code_up(KC_F9);
            break;
    
          case ACTION_SEQ__F19_94:
            code_up(KC_F19);
            break;
