...
/* keys-0 */ KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSLS,
...
/* keys-3 */ _______,_______,_______,KC_SPC,KC_BSPC,KC_SPC,_______,KC_TAB,KC_ENT,KC_LBRC,KC_RBRC,TG(LAYER_PLOVER)
)
  ,
